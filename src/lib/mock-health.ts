...
export const MOCK_APPOINTMENTS: MockAppointment[] = [
  {
    id: "apt-1", offsetDays: 3, time: "10:30am",
    clinic: "NCIS Oncology Clinic", doctor: "Dr. Tan Wei Ming",
    purpose: "Oncology review + blood test", location: "NUH Medical Centre, Level 8",
  },
  {
    id: "apt-2", offsetDays: 8, time: "9:00am",
    clinic: "NUH Imaging Centre", doctor: "Radiology",
    purpose: "PET-CT scan (fasting from midnight)", location: "NUH Main Building, Basement 1",
  },
  {
    id: "apt-3", offsetDays: 12, time: "2:15pm",
    clinic: "Pioneer Polyclinic", doctor: "Pharmacy",
    purpose: "Chronic medication refill", location: "Pioneer Polyclinic, Level 1",
  },
  {
    id: "apt-4", offsetDays: 19, time: "11:00am",
    clinic: "NCIS Oncology Clinic", doctor: "Dr. Tan Wei Ming",
    purpose: "Treatment planning discussion", location: "NUH Medical Centre, Level 8",
  },
];
...
export function writeMockFlag(key: string, value: boolean) {
  try { value ? localStorage.setItem(key, "1") : localStorage.removeItem(key); } catch { /* private mode */ }
}
