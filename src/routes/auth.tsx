      ...
      >
        ...
        <div className="rounded-3xl bg-card border border-border shadow-soft p-7">
          <h1 className="font-serif text-3xl text-balance text-center">
            {mode === "signin" ? "Welcome back." : "You're not alone."}
          </h1>
          <p className="text-sm text-muted-foreground text-center mt-2 leading-relaxed">
            {mode === "signin"
              ? "Sign in to continue your journey."
              : "Create a quiet, private space for your caregiving journey."}
          </p>
          ...
          <Button
            ...
            disabled={busy}
            variant="outline"
            className="w-full h-12 rounded-xl mt-6 bg-card hover:bg-muted border-border"
          >
