    ...
    >
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1.5">A place to walk this journey.</p>
        </div>
      ...
      <Link
        to="/"
        className="text-xs text-muted-foreground/70 mt-6 hover:text-foreground transition"
      >
        ← Back home
      </Link>
    </div>
...
function GoogleIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden>
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.6l6.2 5.2C40.9 35.6 44 30.3 44 24c0-1.3-.1-2.4-.4-3.5z"
      />
    </svg>
  );
}
