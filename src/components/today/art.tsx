...
function TalkArt() {
  return (
    <svg viewBox="0 0 64 64" className="h-12 w-12">
      <rect x="10" y="16" width="34" height="24" rx="8" fill={PAPER} stroke={STROKE} strokeWidth="1.2" />
      <path d="M20 40 l-2 8 8 -8" fill={PAPER} stroke={STROKE} strokeWidth="1.2" strokeLinejoin="round" />
      <rect x="30" y="30" width="24" height="18" rx="7" fill={SAGE_SOFT} stroke={STROKE} strokeWidth="1" opacity="0.9" />
...
function ChecklistArt() {
  return (
    <svg viewBox="0 0 64 64" className="h-12 w-12">
      <rect x="14" y="10" width="36" height="46" rx="4" fill={PAPER} stroke={STROKE} strokeWidth="1.2" />
      <circle cx="22" cy="24" r="3" fill={SAGE} opacity="0.8" />
      <path d="M20.5 24 l1.2 1.4 2 -2.6" stroke={PAPER} strokeWidth="1" fill="none" strokeLinecap="round" />
